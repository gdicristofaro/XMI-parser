...
public class HtmlContent {
	...
	public static String newDoc(Collection<ClassObject> cl) {
		...
		// replace @CLASSDATA
		return document.replace((CharSequence) "@CLASSES", allClasses).replace((CharSequence) "@CLASSDATA", body);
